...
// 全图
function zoomFull() {
    // 使用地图的fullExtent属性来实现全图显示
    if (map && map.fullExtent) {
        map.setExtent(map.fullExtent);
    } else {
        console.error("地图未正确初始化或没有fullExtent属性");
    }
}   
...
var cityCenterData = [
    // 已有的城市坐标
    { name: '南京市', coordX: 118.7879688212, coordY: 32.0616489289 },
    { name: '苏州市', coordX: 120.6298536, coordY: 31.3129079 },
    { name: '无锡市', coordX: 120.3002, coordY: 31.47167 },
    // 新增的城市坐标
    { name: '南通市', coordX: 120.8687202, coordY: 31.9025976 }, // 南通
    { name: '扬州市', coordX: 119.425, coordY: 32.392 },           // 扬州
    { name: '镇江市', coordX: 119.428, coordY: 32.205 },           // 镇江
    { name: '泰州市', coordX: 119.918, coordY: 32.497 },           // 泰州
    { name: '盐城市', coordX: 120.18, coordY: 33.38 },             // 盐城
    { name: '宿迁市', coordX: 118.28, coordY: 33.98 },             // 宿迁
    { name: '徐州市', coordX: 117.18, coordY: 34.26 },             // 徐州
    { name: '淮安市', coordX: 119.02, coordY: 33.58 },             // 淮安
    { name: '连云港市', coordX: 119.16, coordY: 34.58 },           // 连云港
    { name: '常州市', coordX: 119.94, coordY: 31.78 }            // 常州
];
